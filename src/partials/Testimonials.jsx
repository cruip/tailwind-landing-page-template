      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Meet our Officers!</h2>
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ Why did you join LifeSkillsUTD. Insert your major. What workshop/event are you most excited for. Fun hobby or fun fact. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">FirtName LastName</cite>
                <div className="text-gray-600">
                  <span>Officer position</span>
                </div>
                <a className="text-blue-600 hover:underline" href="#0">@YourSocial</a>
              </div>
