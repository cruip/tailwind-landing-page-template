...
import LogoWhiteImage from "../images/logo-wt.png";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-2">
            <div className="mb-2">
              ...
              <Link to="/" className="flex items-center" aria-label="Cruip">
                <img src={LogoWhiteImage} alt="logo" width="90" height="54" />
                <h2 className="text-white font-bold">MashiMashi</h2>
              </Link>
            </div>
          ...
          <div className="sm:col-span-12 lg:col-span-8">
            <ul className="flex flex-grow flex-wrap justify-center items-center text-white">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-white font-bold mb-2">Stay up to date</h6>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8">
          ...
          <div className="text-sm text-white mr-4">
            Copyright © 2022 MashiMashi. All rights reserved
          </div>
        </div>
      </div>
    </footer>
